...
const ContextQ1Page = () => {
  /* 
    ...
    */
        ...
        // isModalOpen을 기준으로 useState를 사용해서 false-숨기기를 기본값으로 지정
  const [isModalOpen, setIsModalOpen] = useState([false, false]);

  return (
    <div>
      <ModalContext.Provider value={{ isModalOpen, setIsModalOpen }}>
        {/* ModalContext.Provider의 값으로 두개를 가져오고
        각 값을 삼항연산자로  조건을 설정해 보이기 값을 정해준다.*/}
        {isModalOpen[0] && isModalOpen[1] && <ContextQ1Modal />}
        <h2>문제 2 - 1</h2>
        <ContextQ1Detail />
